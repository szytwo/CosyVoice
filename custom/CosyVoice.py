...
class CosyVoice:
    ...
    def inference_vc_long(self, source_speech_16k, prompt_speech_16k, stream=False, speed=1.0):    
        ...
        prompt_speech_resample = torchaudio.transforms.Resample(orig_freq=16000, new_freq=self.sample_rate)(prompt_speech_16k)
        prompt_speech_feat, prompt_speech_feat_len = self.frontend._extract_speech_feat(prompt_speech_resample)
        ...
        final_audio = self.crossfade_segments(generated_segments, overlap, self.sample_rate)
